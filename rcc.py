# rcc.py
"""
Created on Fri Aug 27 17:03:26 2021
...
class Localizations:
    ...
    def transform_data(self, mods, gridsize=600, sys_param=None):
    # Transforms the channel according to mods
        ch = tf.Variable( self.pos, dtype = tf.float32)
        mapped_tf = Model.transform_vec(mods, ch, gridsize=gridsize, sys_param=None)
        return np.array(mapped_tf.numpy())
